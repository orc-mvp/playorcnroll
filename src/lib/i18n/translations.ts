...
export const translations = {
  'pt-BR': {
    ...
    character: {
      ...
      distributeAttributes: 'Ordene os tipos de atributos',
      distributeHint: 'Os de cima são Fortes, o do meio é Neutro, os de baixo são Fracos',
      howItWorks: 'Como funciona',
      strongDescription: 'Bônus nos testes e maior chance de Extremo Positivo',
      neutralDescription: 'Sem bônus ou penalidade',
      weakDescription: 'Penalidade nos testes e maior chance de Extremo Negativo',
    ...
    session: {
      ...
      allowedSystemsLabel: 'Sistemas de personagem aceitos',
      allowedSystemsHelp: 'Escolha quais sistemas WoD os jogadores poderão usar nesta sala. Só personagens desses sistemas aparecerão na lista de seleção ao entrar.',
      selectAtLeastOneSystem: 'Selecione ao menos um sistema de personagem aceito',
      editionLabel: 'Edição',
      editionHelp: 'Escolha excludente. Sistemas Clássicos (V3/W20/M20/Metamorfos) são compatíveis entre si. Sistemas 5ª Edição usam motor diferente (pool dividido com dados de Fúria) e não se misturam com Clássicos.',
    ...
    vampiro: {
      ...
      disc_animalism: 'Animalismo',
      disc_auspex: 'Auspícios',
      disc_celerity: 'Celeridade',
      disc_chimerstry: 'Quimerismo',
      disc_dementation: 'Demência',
      disc_dominate: 'Dominação',
      disc_fortitude: 'Fortitude',
      disc_necromancy: 'Necromancia',
      disc_obfuscate: 'Ofuscação',
      disc_obtenebration: 'Obtenebração',
      disc_potence: 'Potência',
      disc_presence: 'Presença',
      disc_protean: 'Metamorfose',
      disc_quietus: 'Quietus',
      disc_serpentis: 'Serpentis',
      disc_thaumaturgy: 'Taumaturgia',
      disc_vicissitude: 'Vicissitude',
      disc_daimonion: 'Daimonion',
      disc_daimoinon: 'Daimoinon',
      disc_melpominee: 'Melpominee',
      disc_mytherceria: 'Mytherceria',
      disc_obeah: 'Obeah',
      disc_sanguinus: 'Sanguinus',
      disc_spiritus: 'Spiritus',
      disc_temporis: 'Temporis',
      disc_thanatosis: 'Thanatosis',
      disc_valeren: 'Valeren',
      disc_visceratika: 'Visceratika',
      disc_flight: 'Voo',
      disc_gargoyle_flight: 'Voo de Gárgula',
      disc_bardo: 'Bardo',
      disc_abombwe: 'Abombwe',
      disc_koldunic_sorcery: 'Feitiçaria Koldúnica',
      disc_nihilistics: 'Nihilistics',
    ...
    vampiroTests: {
      ...
      attributeOnly: 'Só Atributo',
      willpowerOnly: 'Força de Vontade',
      humanityOnly: 'Humanidade',
      virtueOnly: 'Virtude',
      rawDice: 'Dados',
      rawDicePool: 'Quantidade de dados',
      selectAttribute: 'Selecionar Atributo',
    ...
    lobisomem: {
      ...
      form_hispo: 'Hispo',
      form_lupus: 'Lupus',
      changeForm: 'Mudar Forma',
      currentFormLabel: 'Forma atual',
      activeForm: 'Ativa',
      formDifficulty: 'Dificuldade',
      noModifiers: 'Nenhuma alteração nos atributos.',
      formDeliriumWarning: 'Induz o Delírio em seres humanos.',
      confirmTransformation: 'Transformar',
      confirmTransformationWarning: 'Tem certeza que deseja se transformar?',
      confirmYesTransform: 'Sim, transformar!',
      formAttrStrength: 'Força',
      formAttrDexterity: 'Destreza',
      formAttrStamina: 'Vigor',
      formAttrAppearance: 'Aparência',
      formAttrManipulation: 'Manipulação',
      ...
      selectShifterBreed: 'Selecione a raça',
      breed_hominideo: 'Hominídeo',
      breed_impuro: 'Impuro',
      breed_hiena: 'Hiena',
      breed_aranha: 'Aranha',
      breed_felino: 'Felino',
      ...
      breed_urso: 'Urso',
      breed_raposa: 'Raposa',
      breed_lagarto: 'Lagarto',
      breed_serpente: 'Serpente',
      breed_coiote: 'Coiote',
      breed_rato: 'Rato',
      breed_tubarao: 'Tubarão',
      breed_touro: 'Touro',
      breed_morcego: 'Morcego',
      breed_javali: 'Javali',
    ...
    upgrade: {
      bannerMessage: 'Faça upgrade para ter personagens ilimitados, retirar essa barra e contribuir com o desenvolvimento',
      upgradeAction: 'Fazer upgrade',
      manageCharacters: 'Gerenciar personagens',
      modalTitle: 'Limite de personagens atingido',
      modalDescription: 'Fazer upgrade para liberar mais de 3 personagens e apoiar o Orc & Roll.',
      pageTitle: 'Apoiar o Orc & Roll',
      planTitle: 'Apoiador',
      planDescription: 'Personagens ilimitados, sem barra de upgrade e apoio ao desenvolvimento.',
      monthShort: 'mês',
      cardTitle: 'Cartão (recorrente)',
      cardDescription: 'R$ 4,90 cobrados automaticamente todo mês. Cancele quando quiser.',
      pixTitle: 'PIX (mensal manual)',
      pixDescription: 'R$ 4,90 por mês. Você precisa renovar manualmente antes de vencer.',
      ...
      superadminNote: 'Acesso liberado por permissão administrativa.',
      footerNote: 'Pagamento processado de forma segura via Stripe.',
    },
  },
  ...
  en: {
    ...
    character: {
      ...
      distributeAttributes: 'Order attribute types',
      distributeHint: 'Top ones are Strong, middle is Neutral, bottom ones are Weak',
      howItWorks: 'How it works',
      strongDescription: 'Bonus on tests and higher chance of Positive Extreme',
      neutralDescription: 'No bonus or penalty',
      weakDescription: 'Penalty on tests and higher chance of Negative Extreme',
    ...
    session: {
      ...
      allowedSystemsLabel: 'Allowed character systems',
      allowedSystemsHelp: 'Choose which WoD systems players can use in this room. Only characters from these systems will appear in the join list.',
      selectAtLeastOneSystem: 'Select at least one allowed character system',
      editionLabel: 'Edition',
      editionHelp: 'Mutually exclusive. Classic systems (V3/W20/M20/Shifters) are compatible with each other. 5th Edition systems use a different engine (split pool with Rage dice) and cannot mix with Classic.',
    ...
    vampiro: {
      ...
      disc_chimerstry: 'Chimerstry',
      disc_dementation: 'Dementation',
      disc_dominate: 'Dominate',
      disc_fortitude: 'Fortitude',
      disc_necromancy: 'Necromancy',
      disc_obfuscate: 'Obfuscate',
      disc_obtenebration: 'Obtenebration',
      disc_potence: 'Potence',
      disc_presence: 'Presence',
      disc_protean: 'Protean',
      disc_quietus: 'Quietus',
      disc_serpentis: 'Serpentis',
      disc_thaumaturgy: 'Thaumaturgy',
      disc_vicissitude: 'Vicissitude',
      disc_daimonion: 'Daimonion',
      disc_daimoinon: 'Daimoinon',
      disc_melpominee: 'Melpominee',
      ...
      disc_visceratika: 'Visceratika',
      disc_flight: 'Flight',
      disc_gargoyle_flight: 'Gargoyle Flight',
      disc_bardo: 'Bardo',
      disc_abombwe: 'Abombwe',
      disc_koldunic_sorcery: 'Koldunic Sorcery',
      disc_nihilistics: 'Nihilistics',
    ...
    lobisomem: {
      ...
      currentFormLabel: 'Current form',
      activeForm: 'Active',
      formDifficulty: 'Difficulty',
      noModifiers: 'No attribute changes.',
      formDeliriumWarning: 'Induces the Delirium in humans.',
      confirmTransformation: 'Transform',
      confirmTransformationWarning: 'Are you sure you want to transform?',
      confirmYesTransform: 'Yes, transform!',
      formAttrStrength: 'Strength',
      formAttrDexterity: 'Dexterity',
      formAttrStamina: 'Stamina',
      formAttrAppearance: 'Appearance',
      formAttrManipulation: 'Manipulation',
      ...
      selectShifterBreed: 'Select breed',
      breed_hominideo: 'Hominid',
      breed_impuro: 'Impure',
      breed_hiena: 'Hyena',
      breed_aranha: 'Spider',
      breed_felino: 'Feline',
      ...
      breed_urso: 'Bear',
      breed_raposa: 'Fox',
      breed_lagarto: 'Lizard',
      breed_serpente: 'Serpent',
      breed_coiote: 'Coyote',
      breed_rato: 'Rat',
      breed_tubarao: 'Shark',
      breed_touro: 'Bull',
    ...
    upgrade: {
      bannerMessage: 'Upgrade for unlimited characters, remove this bar and support development',
      upgradeAction: 'Upgrade',
      manageCharacters: 'Manage characters',
      modalTitle: 'Character limit reached',
      modalDescription: 'Upgrade to unlock more than 3 characters and support Orc & Roll.',
      pageTitle: 'Support Orc & Roll',
      planTitle: 'Supporter',
      planDescription: 'Unlimited characters, no upgrade bar and direct support to development.',
      monthShort: 'mo',
      cardTitle: 'Card (recurring)',
      cardDescription: 'R$ 4,90 charged automatically every month. Cancel anytime.',
      pixTitle: 'PIX (manual monthly)',
      pixDescription: 'R$ 4,90 per month. You must manually renew before it expires.',
      ...
      superadminNote: 'Access granted by administrative permission.',
      footerNote: 'Payment securely processed by Stripe.',
    },
  },
} as const;

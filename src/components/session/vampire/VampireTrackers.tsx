        ...
        <CardContent className="space-y-2">
          ...
          <div className="space-y-1">
            {Array.from({ length: 5 }, (_, rowIndex) => (
              <div key={rowIndex} className="flex gap-2 md:gap-1 justify-center">
                {Array.from({ length: 10 }, (_, colIndex) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-5 h-5 md:w-3 md:h-3 rounded-sm border transition-colors cursor-pointer hover:border-destructive ${
                        isFilled
            ...
            {Array.from({ length: 10 }, (_, i) => {
              ...
              return (
                <button
                  ...
                  className={`w-6 h-6 md:w-4 md:h-4 rounded-full border-2 transition-colors cursor-pointer hover:border-foreground ${
                    isFilled
                      ? 'bg-foreground border-foreground'
                      : 'border-muted-foreground/40 bg-transparent'
                  }`}
